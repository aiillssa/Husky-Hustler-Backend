...
export const listBlobs = async (req: Request, res: Response) => {
    ...
    try {
        ...
        res.json({ message: "[blobController] - successfully loaded blob list", blobs });
    } catch (error) {
...
export const downloadBlob = async (req: Request, res: Response) => {
    ...
    try {
        ...
        res.status(500).send("[blobController] - An error occurred while downloading the blob.");
    }
}
...
export const uploadBlob = async (req: Request, res: Response) => {
    ...
    try {
        ...
        console.log(err)
        res.status(500).send("[blobController, uploadBlob] - An error occurred while uploading the image.");
    }
...
export const deleteBlob = async (req: Request, res: Response) => {
    ...
    try {
        ...
        res.status(400).send("[blobController, deleteBlob] - failed to delete blobs")
    }
